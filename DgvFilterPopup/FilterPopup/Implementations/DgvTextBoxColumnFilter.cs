    ...
    public partial class DgvTextBoxColumnFilter : DgvBaseColumnFilter {
        ...
        protected override void OnFilterInitializing(object sender, CancelEventArgs e) {
            ...
            if (ColumnDataType == typeof(string))
                comboBoxOperator.Items.AddRange (new object[] { "..xxx..","xxx..","..xxx" , "=", "<>", "= осярн", "<> осярн" });
            else
                comboBoxOperator.Items.AddRange(new object[] { "=", "<>", ">", "<", "<=", ">=", "= осярн", "<> осярн" });
        ...
        protected override void OnFilterExpressionBuilding(object sender, CancelEventArgs e){
            ...
            if (comboBoxOperator.Text == "= осярн") ResultFilterExpression = GetNullCondition(this.DataGridViewColumn.DataPropertyName);
            if (comboBoxOperator.Text == "<> осярн") ResultFilterExpression = GetNotNullCondition(this.DataGridViewColumn.DataPropertyName);
